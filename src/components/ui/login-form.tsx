...
export function LoginForm({
  ...
  return (
    <form className={cn("flex flex-col gap-6 bg-pink-50 p-6 rounded-lg shadow-md", className)} {...props}>
      ...
      <div className="grid gap-6">
        <div className="grid gap-2">
          ...
          <Input id="email" type="email" placeholder="more@more.com" required className="border-red-300 focus:ring-red-500" />
        </div>
        <div className="grid gap-2">
          ...
          <Input id="password" type="password" required className="border-red-300 focus:ring-red-500" />
        </div>
